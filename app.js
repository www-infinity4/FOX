(function(){
  ...
  function tick(){
    ...
    if(!entered){const inlineReady=!!(state.segment.videoId&&state.segment.cleared&&!failedVideoIds.has(state.segment.videoId));els.enter.innerHTML=inlineReady?"<span>Enter FOX</span><small>Join the program at the moment airing now</small>":"<span>View "+state.block.movie.title.replace(/[<>&]/g,"")+"</span><small>This scheduled program opens from its official available source</small>";}
